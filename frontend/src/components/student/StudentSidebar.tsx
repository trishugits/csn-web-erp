...
const menuItems = [
  ...
  { icon: FileText, label: "Notices", path: "/student/notices" },
  { icon: DollarSign, label: "Fees and Payments", path: "/student/fees" },
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="p-6 border-b border-sidebar-border">
          <h1 className="text-2xl font-bold text-sidebar-foreground">
            School<span className="text-primary">Portal</span> <span className="text-xs text-sidebar-foreground/60">Student</span> <br />  
          </h1>
        </div>
